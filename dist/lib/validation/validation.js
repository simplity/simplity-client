...
exports.FALSE_VALUE = exports.TRUE_VALUE = exports.DEFAULT_NBR_DECIMALS = exports.DEFAULT_MAX_NUMBER = exports.DEFAULT_DAYS_RANGE = exports.DEFAULT_MAX_CHARS = void 0;
...
exports.TRUE_VALUE = 'true';
exports.FALSE_VALUE = 'false';
 ...
 */
function parseValue(textValue, valueType) {
...
function validateText(schema, value) {
    ...
    const max = schema.maxLength || exports.DEFAULT_MAX_CHARS;
...
function validateNumber(schema, value) {
    ...
    const max = schema.maxValue || exports.DEFAULT_MAX_NUMBER;
    if (schema.valueType == 'integer') {
        nbr = Math.round(nbr);
    }
    else {
        const n = schema.nbrDecimalPlaces || exports.DEFAULT_NBR_DECIMALS;
...
function validateDate(schema, value) {
    ...
    const pastDays = schema.maxPastDays || exports.DEFAULT_DAYS_RANGE;
    const futureDays = schema.maxFutureDays || exports.DEFAULT_DAYS_RANGE;
...
function parseBoolean(text) {
    ...
    if (t === exports.TRUE_VALUE || t === '1') {
        return true;
    }
    if (t === exports.FALSE_VALUE || t === '0') {
        return false;
    }
    return undefined;
}
